...
> Warning
>
> This repo is for learning purposes only, all credits goes to the linked authors.
...
- https://twitter.com/iam_preethi/status/1480930117656395781?s=20
- https://mothereff.in/byte-counter
- https://docs.soliditylang.org/en/latest/yul.html
- https://github.com/Rari-Capital/solcurity
- https://youtu.be/qwBkeJ84d2g
...
- `forge snapshot`
- `forge test -vvvvv`
- `forge inspect FunctionNames methods `
- `forge test --debug <functionName>`
- `forge test --debug testYul`
- `forge test --match-contract ZeroNonZero --gas-report > ./__gasReports/zeroNonZero.txt`
- `forge snapshot --match-contract ZeroNonZero --asc --snap ./__snapshots/zeroNonZero`

- https://github.com/dabit3/foundry-cheatsheet

## EIP-1159

#### Prior London Hard Fork:

```
Transaction Fee = Gas cost X Gas price
```
...
#### After London Hard Fork:

- **Base Fee** - This is the base fee per unit of gas that is used in that transaction. This fee is determined by the Ethereum network itself. This “fee” is subsequently **burned**.
- **Max Priority Fee** - An optional tip that is paid directly to miners. The tip would be calculated as `Max priority fee x Gas cost`
- **Max Fee Per Gas** - The absolute maximum you are willing to pay per unit of gas to get your transaction included in a block (this is similar to “Gas price”, except now it includes both the Base Fee + Max Priority fee)
